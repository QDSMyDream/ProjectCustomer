...
public class ShowProjectsActivity extends AppCompatActivity {
    ...
    private List<String> customerProjectsStrings = new ArrayList<>();//总项目名称
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //创建项目弹窗
        showCustomerProjectsDialogbuild = new ShowCustomerProjectsDialog.Builder(ShowProjectsActivity.this)
    ...
    private AdapterView.OnItemLongClickListener onItemLongClickListener = new AdapterView.OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            selectCustomerProjectsItemId = position;
            selectCustomerProjectsItem = (CustomerProjectsItem) customerPeojectsListAdapter.getItem(position);
            DeleteDialog.Builder builder = new DeleteDialog.Builder(ShowProjectsActivity.this);
...
//                    Toast.makeText(getBaseContext(), "拉取服务项目列表失败，请检查网络！" + e.getMessage(), Toast.LENGTH_LONG).show();
            ...
            switch (msg.what) {
                ...
                case 6:
                    ...
                    if (customerProjectsItems.size() > 0) {
                        if (customerProjectsItems.size() > 0) {
                            for (int i = 0; i < customerProjectsItems.size(); i++) {
                                moneys = moneys + customerProjectsItems.get(i).getcMoney();
                            }
                            //客户总缴费
                            moneyEd.setText(moneys + "");
                            noProjectsLayout.setVisibility(View.GONE);
                            viewLineList.setVisibility(View.VISIBLE);
                            titleLayout.setVisibility(View.VISIBLE);
    ...
    private View.OnClickListener addTimeStartClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            addTimeDialogBuild = new AddTimeDialog.Builder(ShowProjectsActivity.this, true, textView);
...
//                    customer.getProjectsTexts().remove(customerProjectsItem);
    ...
    private void updateCustomer() {
        ...
        customer.setRemarks(mAddContent.getText().toString());
...
//                    Toast.makeText(getBaseContext(), "拉取服务项目列表失败，请检查网络！" + e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void setSignProject() {
        AddSignDialog.Builder addSignDialogBuild = new AddSignDialog.Builder(ShowProjectsActivity.this);
