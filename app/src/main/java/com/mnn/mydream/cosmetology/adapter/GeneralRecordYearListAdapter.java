...
public class GeneralRecordYearListAdapter extends BaseAdapter {

    private String TAG = "GeneralRecordYearListAdapter";
    ...
    public GeneralRecordYearListAdapter(Context mContext, List<CustomerProjectsItem> comingslist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.general_record_year_card_item_layout, null);
        ...
        holder.yearCard.setText(costorBean.iscCardYearFlag() ? "是" : "否");
        holder.itemPeojectsStartTime.setText(costorBean.getcStartTime());
        holder.itemPeojectsEndTime.setText(costorBean.getcEndTime());
