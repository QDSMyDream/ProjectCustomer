...
public class AppMsg {
     ...
     */
    public static final Style STYLE_ALERT = new Style(LENGTH_LONG, R.color.custom, R.color.white);

    public static final Style STYLE_GULES = new Style(LENGTH_LONG, R.color.accent, R.color.white);

    /**
     * Show the text notification for a short period of time with a positive style.
     */
    public static final Style STYLE_CONFIRM = new Style(LENGTH_SHORT, R.color.confirm, R.color.white);

    /**
     * Show the text notification for a short period of time with a neutral style.
     */
    public static final Style STYLE_INFO = new Style(LENGTH_SHORT, R.color.info, R.color.white);
    ...
    public static class Style {
         ...
         * @param color
         */
        public Style(int duration, int resId, int color) {
