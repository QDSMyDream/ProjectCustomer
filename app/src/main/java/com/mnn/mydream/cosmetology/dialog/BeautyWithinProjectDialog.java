...
public class BeautyWithinProjectDialog extends Dialog {

    public BeautyWithinProjectDialog(Context context) {
        super(context);
    }

    public BeautyWithinProjectDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public BeautyWithinProjectDialog createDialog() {

            BeautyWithinProjectDialog dialog = new BeautyWithinProjectDialog(context, R.style.ShowDetailsCustomer_Dialog);
            View contentView = LayoutInflater.from(context).inflate(R.layout.beauty_within_project_dialog, null);
