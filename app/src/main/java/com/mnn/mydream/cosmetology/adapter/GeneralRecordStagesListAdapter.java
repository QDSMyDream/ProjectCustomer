...
public class GeneralRecordStagesListAdapter extends BaseAdapter {

    private String TAG = "GeneralRecordStagesListAdapter";
    ...
    public GeneralRecordStagesListAdapter(Context mContext, List<CustomerProjectsItem> comingslist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.general_record_stages_item_layout, null);
        ...
        holder.isStages.setText(costorBean.isStages() ? "是" : "否");
        holder.itemMoney.setText(costorBean.getcStagesMoney() + "");
        holder.stagesMoney.setText(costorBean.getcStagesSurplusMoney() + "");
