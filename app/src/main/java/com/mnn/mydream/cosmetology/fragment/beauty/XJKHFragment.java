...
public class XJKHFragment extends Fragment implements View.OnClickListener {
...
// 如果有parent需要从parent删除，要不然会发生这个view已经有parent的错误。
    ...
    private void initView() {
        ...
        xjkhView = mInflater.inflate(R.layout.xjkh_view_layout, null);
        xjkhViewFindViewInit(xjkhView);
        xjkhViewInit();

        mViewList.add(xjkhView);
        ...
        tabs.setupWithViewPager(viewpagers, false);
        //给TabLayout设置适配器
